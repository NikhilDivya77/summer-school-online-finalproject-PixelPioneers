...
//     async function loadProfile() {
//         try {
//             const response = await fetch("https://newgatecse.onrender.com/api/auth/profile", {
//                 headers: {
//                     Authorization: `Bearer ${token}`,
//                 },
//             });
...
//             try {
//                 const response = await fetch("https://newgatecse.onrender.com/api/auth/password", {
//                     method: "PUT",
//                     headers: {
//                         "Content-Type": "application/json",
//                         Authorization: `Bearer ${token}`,
...
//                 // Set profile image with fallback and cache-busting
//                 const storedPic = localStorage.getItem("profilePic");
//                 const profilePicUrl = result.user.profilePicUrl && result.user.profilePicUrl !== "null" ? 
//                     `${result.user.profilePicUrl}?t=${Date.now()}` : 
...
//                     profileImage.src = "../profile-placeholder.png";
//                 };
...
//                 if (response.ok) {
//                     if (!result.user.profilePicUrl || result.user.profilePicUrl === "null") {
//                         throw new Error("Server returned an invalid profile picture URL");
//                     }
//                     localStorage.setItem("profilePic", result.user.profilePicUrl);
//                     profileImage.src = `${result.user.profilePicUrl}?t=${Date.now()}`;
//                     profileImage.onerror = () => {
...
//                 // Set profile image with validation and fallback
//                 const storedPic = localStorage.getItem("profilePic");
//                 const profilePicUrl = result.user.profilePicUrl && result.user.profilePicUrl !== "null" ? 
//                     `${result.user.profilePicUrl}?t=${Date.now()}` : 
//                     storedPic && storedPic !== "null" ? 
...
//                 // Set profile image with validation and fallback
//                 const storedPic = localStorage.getItem("profilePic");
//                 const profilePicUrl = result.user.profilePicUrl && result.user.profilePicUrl.trim() !== "" && result.user.profilePicUrl !== "null" ? 
//                     `${result.user.profilePicUrl}?t=${Date.now()}` : 
//                     storedPic && storedPic.trim() !== "" && storedPic !== "null" ? 
//                     `${storedPic}?t=${Date.now()}` : 
//                     "../profile-placeholder.png";
//                 profileImage.src = profilePicUrl;
...
//                 // Handle image load errors
//                 profileImage.onerror = () => {
//                     console.error("Image failed to load, using placeholder:", profileImage.src);
//                     profileImage.src = "../profile-placeholder.png";
//                 };
...
//                         try {
//                             const result = JSON.parse(xhr.responseText);
//                             if (!result.user.profilePicUrl || result.user.profilePicUrl.trim() === "" || result.user.profilePicUrl === "null") {
//                                 throw new Error("Server returned an invalid or empty profile picture URL");
//                             }
//                             localStorage.setItem("profilePic", result.user.profilePicUrl);
//                             profileImage.src = `${result.user.profilePicUrl}?t=${Date.now()}`;
//                             profileImage.onerror = () => {
//                                 console.error("Uploaded image failed to load, using placeholder:", result.user.profilePicUrl);
//                                 profileImage.src = "../profile-placeholder.png";
//                             };
//                             if (uploadProgress) {
//                                 uploadProgress.value = 100;
                ...
                xhr.onload = () => {
                    if (xhr.status >= 200 && xhr.status < 300) {
                        try {
                            ...
                            profileImage.src = `${result.user.profilePicUrl}?t=${Date.now()}`;
                            profileImage.onerror = () => {
                                console.error("Uploaded image failed to load, using placeholder");
                                profileImage.src = "../profile-placeholder.png";
                            };
                            if (uploadProgress) {
                                uploadProgress.value = 100;
